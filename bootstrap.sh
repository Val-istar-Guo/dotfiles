...
source "$SCRIPT_DIR/lib/bootstrap_crontab.sh"
...
#===== 安装 CLI 工具 =====
log_step "安装 dotfiles CLI 工具"

readonly CLI_SOURCE="$DOTFILES_DIR/dotfiles"
readonly CLI_TARGET="$HOME/.local/bin/dotfiles"
...
if [[ -f "$CLI_SOURCE" ]]; then
  ...
  log_success "已安装 CLI 工具: dotfiles"
  log_info "现在可以使用: dotfiles upgrade"
else
  log_warning "未找到 CLI 工具: $CLI_SOURCE"
fi
